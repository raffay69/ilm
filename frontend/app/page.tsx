              ...
              <div className="text-center space-y-8">
                <div className="space-y-6">
                  <div className="space-y-4">
                    <h1 className="text-6xl lg:text-8xl font-bold text-primary-800 font-arabic">
                      ilm
                    </h1>
                    <p className="text-2xl lg:text-3xl text-primary-600 font-medium">
                  ...
                  <p className="text-xl text-primary-700 font-arabic leading-relaxed max-w-3xl mx-auto">
                    Experience education like never before. From complex
                    academic concepts to coding challenges like LeetCode
                    problems, get comprehensive explanations paired with
                    engaging visual content that brings knowledge to life.
                  </p>
                </div>
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center space-y-4 mb-16">
                ...
                <p className="text-xl text-primary-600 max-w-3xl mx-auto">
                  Whether you're studying for exams, solving coding problems, or
                  exploring new topics, ilm adapts to your learning style
                </p>
              </div>
                  ...
                  <div className="card text-center space-y-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-primary-600">
                        Master complex topics in physics, chemistry, biology,
                        mathematics, and more with visual explanations.
                      </p>
                    </div>
                ...
                <FadeIn delay={0.3}>
                  <div className="card text-center space-y-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-primary-600">
                        Understand LeetCode problems, data structures,
                        algorithms, and programming concepts with step-by-step
                        breakdowns.
                      </p>
                    </div>
                ...
                <FadeIn delay={0.6}>
                  <div className="card text-center space-y-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-primary-600">
                        Explore history, science, technology, and current events
                        with comprehensive visual explanations.
                      </p>
                    </div>
          ...
          <section className="py-20 bg-gradient-to-br from-primary-50 to-secondary-50 relative">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center space-y-4 mb-16">
                <h2 className="text-3xl lg:text-4xl font-bold text-primary-900">
                  How{" "}
                  <span className="font-arabic text-primary-600 text-5xl">
                    ilm{" "}
                  </span>
                  Works
                </h2>
                <p className="text-xl text-primary-600 max-w-3xl mx-auto">
                  Our intelligent system transforms your educational queries
                  into comprehensive learning experiences
                </p>
              </div>
                    ...
                    <div className="group">
                      <div className="card text-center space-y-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 relative">
                        ...
                        <div className="space-y-3">
                          ...
                          <p className="text-primary-600">
                            Enter any topic, from academic subjects to coding
                            problems like "Two Sum LeetCode" or "Explain machine
                            learning".
                          </p>
                        </div>
                        <div className="bg-primary-50 rounded-lg p-4">
                          ...
                          <div className="space-y-1 text-sm text-primary-800">
                            <div className="bg-white rounded-md p-2 border border-primary-200">
                    ...
                    <div className="group">
                      <div className="card text-center space-y-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 relative">
                        ...
                        <div className="space-y-3">
                          ...
                          <p className="text-primary-600">
                            Our advanced AI analyzes your query and generates
                            comprehensive explanations tailored to your learning
                            needs.
                          </p>
                        </div>
                    ...
                    <div className="group">
                      <div className="card text-center space-y-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 relative">
                        ...
                        <div className="space-y-3">
                          ...
                          <p className="text-primary-600">
                            Receive detailed text explanations plus engaging
                            videos that visualize algorithms, concepts, and
                            solutions.
                          </p>
                        </div>
                    ...
                    <FadeIn>
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-primary-600">
                            Get detailed, step-by-step explanations for any
                            topic, from calculus to coding algorithms
                          </p>
                        </div>
                      </div>
                    </FadeIn>
                    ...
                    <FadeIn>
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-primary-600">
                            Watch concepts come to life through engaging video
                            content and algorithm visualizations
                          </p>
                        </div>
                      </div>
                    </FadeIn>
                    ...
                    <FadeIn>
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-primary-600">
                            Perfect for understanding LeetCode problems, data
                    ...
                    <FadeIn>
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-primary-600">
                            Save your generated content for offline learning and
                    ...
                    <FadeIn>
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-primary-600">
                            Perfect for students, developers, educators, and
                            lifelong learners
                          </p>
                        </div>
                      </div>
                ...
                <div className="card bg-gradient-to-br from-white to-primary-50 relative overflow-hidden">
                  <div className="relative space-y-6">
                    <div className="text-center">
                      ...
                      <p className="text-primary-600 mt-6">
                    ...
                    <div className="bg-primary-100 rounded-lg p-4 text-center">
                      <p className="text-primary-800 font-medium">
                        "From complex algorithms to scientific theories, ilm
                        makes every concept crystal clear"
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-primary-200">
                    Join thousands of learners and developers who are already
                    mastering complex topics with ilm
                  </p>
                </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-center md:text-right">
                <p className="text-primary-300">
                  © 2025 ilm. Empowering minds through visual learning.
                </p>
              </div>
            </div>
          </div>
